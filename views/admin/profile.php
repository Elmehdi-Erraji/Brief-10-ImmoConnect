                                                    ...
                                                    <form action="updateProfile" method="POST" id="userForm" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row row-cols-sm-2 row-cols-1">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="tel" name="phone" value="<?php echo $user->getPhoneNumber(); ?>" placeholder="Enter phone number" id="phone" class="form-control">
                                                                <span id="phoneError" class="error-message"></span> <!-- Error span for phone number -->
                                                            </div>
                                                            <div class="mb-3">
